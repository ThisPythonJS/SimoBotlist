...
Mudanças realizadas:
✅ Alterado ephemeral: true para flags: ["Ephemeral"] na resposta de validação
✅ Removidos todos os emojis dos textos de mensagens e labels dos botões
✅ Mantido apenas o emoji 🔔 no título/descrição da embed
